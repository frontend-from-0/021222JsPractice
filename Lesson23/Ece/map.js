...
const strings = numbersExercise6.map((num) => num.toString());
console.log("Exercise 6", strings);
...
const book = booksExercise9.map((book) => book.title + " ," + book.author);
console.log("Exercise9", book);
...
console.log("Exercise10", priceWithSymbol);
