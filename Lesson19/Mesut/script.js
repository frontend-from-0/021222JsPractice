...
lastListItem.innerText = "Last item";
unOrderedList.appendChild(lastListItem);
...
toggleButton.innerText = "Hide Images";
document.body.appendChild(toggleButton);

toggleButton.addEventListener("click", function () {
  if (toggleButton.innerText === "Hide Images") {
    toggleButton.innerText = "Show Images";
    for (let i = 0; i < images.length; i++) {
