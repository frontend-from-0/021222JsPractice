...
function exercise3(a, b) {
  ...
  if (a < b) {
    ...
    console.log('The first number and the second number are equal.')
  } 
}else {
...
function exercise4(string) {
  if (typeof string === 'string') {
    if (string[0] === string[0].toUpperCase()) {
      console.log('The first letter of the string is uppercase.')
    } else {
      console.log('The first letter of the string is not uppercase.')
    }
  } else {
...
function exercise7(temp){
  if (typeof temp === 'number') {
    ...
    console.log("Please provide a valid number for temperature.");
  }
}
...
function exercise8(height, weight){
  if (typeof weight === 'number' && typeof height === 'number' && height > 0 && weight > 0) {
    ...
    return "Please provide valid weight (in kg) and height (in meters).";
  }
}
...
function exercise9(age){
  if(typeof age === 'number' && age>=0){
    ...
    console.log("Please provide a valid number for age.")
  }
}
...
function exercise10(age, isStudent) {
  if (age < 18 && isStudent === 'yes') {
    ...
    console.log("Invalid input. Please provide a valid age and student status (yes or no).");
  }
}
...
function exercise11(salary, yearsOfExperience) {
  if (salary < 30000 && yearsOfExperience < 5) {
    ...
    console.log("Invalid input. Please provide a valid salary and years of experience.");
  }
}
...
function exercise12(score) {
  if (score < 60) {
    ...
    console.log("Invalid score. Please provide a valid score.");
  }
}
...
function exercise14(grade) {
  switch (grade) {
    ...
    case "F":
      ...
      break;
    default:
      console.log("Invalid grade. Please provide a valid grade (A, B, C, D, or F).");
      break;
  }
}
...
function exercise15(humanAge) {
  if (humanAge > 0) {
    let dogAge = humanAge * 7;
    console.log(`Your age in dog years is ${dogAge} years.`);
  } else {
    console.log("Please enter a positive number for human age.");
  }
}
